...
export async function POST(req) {
  ...
  const prompt = `You are helping an English-speaking interviewer conduct an interview in Chinese. Based on the conversation so far, generate 4 insightful follow-up questions the interviewer might want to ask.
...
- "chinese": the question translated to natural Mandarin Chinese (how it will be spoken aloud)
